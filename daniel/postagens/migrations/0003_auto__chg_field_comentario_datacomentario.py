...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('postagens_comentario', 'datacomentario', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'postagens.comentario': {
            ...
            'datacomentario': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
