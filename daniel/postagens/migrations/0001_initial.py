...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('postagens_comentario', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['postagens.Postagem'])),
            ...
            ('datacomentario', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('postagens', ['Comentario'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('postagens_comentario')
    ...
    models = {
        ...
        'postagens.comentario': {
            ...
            'datacomentario': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
